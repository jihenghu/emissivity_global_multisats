...
subroutine read_ERA5_profiles(filename,lon,lat,qw,ta,retIO)
	...
	REAL*4, DIMENSION(nlon,nlat,nlevel,ntime) :: qw,ta!!kg/kg, %, K, m2/s2 
...
! subroutine read_ERA5_landvars(filename,skt,psrf,t2m,stl1,swvl1,snowc,sde)
	...
	character*(*) :: filename
	INTEGER,Parameter :: nlon=1440, nlat=561,ntime=1
	REAL*4, DIMENSION(nlon,nlat,ntime) :: skt,psrf,t2m,snowc,swvl1

	! REAL*4, DIMENSION(nlon,nlat,ntime) :: stl1,sde
...
subroutine read_ERA5_single(filename,sst,psrf,t2m)
